...
class Homepage(tk.Tk):
    ...
    def all_widgets(self):
        ...
        self.todo_btn = tk.Button(self, text="To do list", command=main)
    ...
    def show_widgets(self):
        ...
        self.todo_btn.place(x=149.0, y=346.0, width=94.0, height=28.0)
        self.timer_btn.place(x=149.0, y=406.0, width=94.0, height=28.0)
        self.weather_btn.place(x=149.0, y=470.0, width=94.0, height=28.0)
homepage = Homepage()
homepage.mainloop()
